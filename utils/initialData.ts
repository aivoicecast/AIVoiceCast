...
export const HANDCRAFTED_CHANNELS: Channel[] = [
  {
    ...
    description: 'The 0-indexed Technical Manifest (v8.8.0). Domains A-E: Socratic friction, Emotive Link, Heuristic Simulation, and BCP thermodynamics.',
    ...
    dislikes: 0,
    comments: [],
    tags: ['Audit', 'Technical', 'Socratic', 'v8.8.0'],
    imageUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=600&q=80',
    welcomeMessage: "Handshake verified. v8.8.0 Technical Audit active. Ready to refract Domain A: Philosophy via Sector 00?",
    createdAt: Date.now()
  },
  {
    id: 'judge-deep-dive',
    title: '🏆 JUDGE: Technical Audit',
    description: 'v8.8.0-COMPLETE Technical manifest. Multi-model orchestration, BCP sharding, and Heuristic Simulation thermodynamics.',
    author: 'Project Lead',
    voiceName: 'Default Gem',
    systemInstruction: 'You are the Project Lead for Neural Prism. Conduct a technical audit for a hackathon judge based on the v8.8.0 manifest. Focus on the Earn/Spend = 1.0 goal, achieved via 18x Flash concurrency and 100x community knowledge caching.',
    likes: 2100,
    dislikes: 0,
    comments: [],
    ...
    welcomeMessage: "Welcome, Auditor. v8.8.0-COMPLETE Technical Audit is now live. We have achieved 100% sector parity with the 0-indexed manifest.",
    createdAt: Date.now()
  },
  {
    id: OFFLINE_CHANNEL_ID,
    title: 'Neural Prism Platform Guide',
    description: 'v8.8.0 Self-documenting guide. Master the Sovereign Signer, the Offline Trust Root, and the Unified Refraction engine.',
    author: 'Prism Architect',
    voiceName: 'Default Gem',
    systemInstruction: 'You are the lead architect of Neural Prism. You explain the technical implementation of the platform, focusing on our v8.8.0 0-indexed manifest.',
    likes: 18200,
    dislikes: 0,
    comments: [],
    tags: ['Architecture', 'Guide', 'OfflineReady', 'v8.8.0'],
    imageUrl: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=200&q=80', 
    welcomeMessage: "Welcome to the Neural Prism v8.8.0. We have achieved 100% verification parity. Ready to audit?",
