...
export const HANDCRAFTED_CHANNELS: Channel[] = [
  {
    ...
    dislikes: 0,
    comments: [],
    tags: ['Audit', 'v7.0.0-ULTRA', 'Socratic', 'InterviewPrep'],
    imageUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=600&q=80',
    welcomeMessage: "Handshake verified. Technical Audit v7.0.0-ULTRA-PRO active. Ready to refract the Socratic paradigm?",
    createdAt: Date.now()
  },
  {
    id: 'judge-deep-dive',
    title: '🏆 JUDGE: Technical Audit v7.0.0-ULTRA',
    description: 'Technical manifest for Hackathon Judges. Examining the v7.0.0-ULTRA infrastructure-bypass and BCP sharding protocols.',
    author: 'Project Lead',
    voiceName: 'Default Gem',
    systemInstruction: 'You are the Project Lead for Neural Prism. Conduct a technical audit for a hackathon judge. Focus on v7.0.0-ULTRA improvements: The Complexity Balancer v4, the Binary Chunking Protocol (BCP) for bypassing 1MB database limits, and the Heuristic Simulation engine that achieves a 10x energy efficiency gain.',
    likes: 1850,
    dislikes: 0,
    comments: [],
    tags: ['Judging', 'v7.0.0-ULTRA', 'Architecture', 'Sovereignty'],
    imageUrl: 'https://images.unsplash.com/photo-1507413245164-6160d8298b31?w=600&q=80',
    welcomeMessage: "Welcome, Auditor. Technical Audit v7.0.0-ULTRA is now live. We have hardened the engine with the BCP sharding and deterministic PDF baking.",
    createdAt: Date.now()
  },
  {
    id: OFFLINE_CHANNEL_ID,
    title: 'Neural Prism Platform v7.0.0-ULTRA',
    description: 'The self-documenting guide to the Neural Prism v7.0.0-ULTRA Platform. Master the Sovereign Signer and the Offline Trust Root.',
    author: 'Prism Architect',
    voiceName: 'Default Gem',
    systemInstruction: 'You are the lead architect of Neural Prism. You explain the technical implementation of the platform, focusing on the v7.0.0-ULTRA update.',
    likes: 16800,
    dislikes: 0,
    comments: [],
    ...
    welcomeMessage: "Welcome to Neural Prism v7.0.0-ULTRA. We have achieved 100% verification parity. Ready to audit?",
