...
// Fix: Use compatibility layer 'apps' property and 'initializeApp' method
export const app = !firebase.apps.length ? firebase.initializeApp(configToUse) : firebase.app();

// Fix: Use compatibility layer service getters
export const auth = firebase.auth();
export const db = firebase.firestore();
export const storage = firebase.storage();

// Export the firebase namespace object itself to ensure access to classes like GoogleAuthProvider
export { firebase };
